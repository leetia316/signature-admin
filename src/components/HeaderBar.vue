<template>
    <div class="headerBar">
        <div class="title">
            ...
            <span>西南管道电子签名系统</span>
        </div>
        <div class="right-menu-container">
            <Menu mode="horizontal" theme="dark" :active-name="node" @on-select="changeActiveName">
            ...
            <div class="user-menu">
                ...
                <a style="color: aliceblue"  @click="goBack()"><span class="iconfont icon-tuichu1" style="margin-left: 10px;font-size: 16px" >退出</span></a>
            </div>
        </div>
    </div>
</template>
